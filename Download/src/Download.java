...
/*
            ...
            String proxyIP="cache.mrt.ac.lk";
            ...
            if (proxyRequired){
            	...
            	System.out.println("proxy setting completed");
            	}
            	...
            	String encoded = new String( Base64.getEncoder().encodeToString( new String( proxyUsername + ":" + proxyPassword).getBytes()).toString());
...
public static final String proxyIP = "cache.mrt.ac.lk";
...
// Get this download's URL.saveDir
public String getUrl() {
return url.toString();
}
